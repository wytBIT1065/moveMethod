...
/*	 public ResultModel handleRename(RenameJavaElementDescriptor renameDescriptor){
	...
	public ResultModel handleRename(MoveMethodDescriptor renameDescriptor){
...
//		return renameData;
//	}	
	private DataModel getRenameData(MoveMethodDescriptor renameDescriptor){
		DataModel renameData = new DataModel();		
		
		if(renameDescriptor.getID().equals("org.eclipse.jdt.ui.move.method")){			
			renameData = handleTypeRename(renameDescriptor);
		} else {
			return null;
		}
 	...
 	private DataModel handleTypeRename(MoveMethodDescriptor renameDescriptor){
		DataModel renameData = new DataModel();
		...
		renameData.oldPackageName = originalElement;
